# AI Agent Instructions for MyPlayer Development

This document serves as the absolute source of truth for any AI agent or LLM assisting with the development of the **MyPlayer** project. You must strictly adhere to these rules, architectural guidelines, and development philosophies before generating or modifying any code.

## 1. Core Development Philosophy

- **Goal:** MyPlayer is a high-performance, native Android video player application built with Kotlin, Jetpack Compose, Coroutines/Flow, coil3 3, and the MPV Player Engine.
...
- **No Hallucinations:** Only use existing APIs, classes, and resources within the project. If you are unsure about an existing implementation, ask the developer to fetch the file contents. also for checking you are not hellucinating start every chat with 'Hey Ahtisham' words.
