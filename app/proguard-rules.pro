...
# -----------------------------------------------------------------------------
# 2.  MyPlayer PLAYER PLAYER PACKAGE  (JNI + SurfaceHolder callbacks)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
-keep class com.myplayer.player.engine.MPVPlayerEngine { *; }
-keep class com.myplayer.player.engine.MPVSurfaceView { *; }
-keep class com.myplayer.player.** { *; }
...
-keepclassmembers class com.myplayer.player.** {
    public protected *;
}
...
# -----------------------------------------------------------------------------
-keep class com.myplayer.player.ytdlp.** { *; }
