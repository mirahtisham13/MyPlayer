package com.myplayer.player.service
...
import com.myplayer.MainActivity
...
class MediaPlaybackService : Service() {
    ...
    private val receiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            when (intent?.action) {
                ...
                ACTION_PREV -> {
                    val broadcastIntent = Intent("com.myplayer.PIP_PREV").apply {
                        setPackage(packageName)
                    }
                    sendBroadcast(broadcastIntent)
                }
                ACTION_NEXT -> {
                    val broadcastIntent = Intent("com.myplayer.PIP_NEXT").apply {
                        setPackage(packageName)
                    }
                    sendBroadcast(broadcastIntent)
                }
    ...
    companion object {
        ...
        const val ACTION_TOGGLE_PLAYBACK = "com.myplayer.ACTION_TOGGLE_PLAYBACK"
        const val ACTION_STOP = "com.myplayer.ACTION_STOP"
        const val ACTION_PREV = "com.myplayer.ACTION_PREV"
        const val ACTION_NEXT = "com.myplayer.ACTION_NEXT"
        const val ACTION_REWIND = "com.myplayer.ACTION_REWIND"
        const val ACTION_FORWARD = "com.myplayer.ACTION_FORWARD"
    ...
    override fun onCreate() {
        ...
        mediaSession = MediaSessionCompat(this, "MyPlayerMediaSession").apply {
            isActive = true
    ...
    private fun updateNotification() {
        ...
        val metadataBuilder = MediaMetadataCompat.Builder()
            ...
            .putString(MediaMetadataCompat.METADATA_KEY_ARTIST, "MyPlayer")
