...
import com.myplayer.data.repository.VideoRepository
...
import com.myplayer.util.getAvailableStorageVolumes
...
class VideoListViewModel(
    ...
    fun selectFolder(folder: VideoFolder?) {
        ...
        if (folder != null) {
            ...
            com.myplayer.domain.thumbnail.ThumbnailRepository.getInstance(repository.context)
    ...
    fun updateShowWatchBadge(show: Boolean) {
        viewModelScope.launch {
            viewSettingsRepo.updateShowWatchBadge(show)
        }
    }

    fun updateFolderShowCount(show: Boolean) {
        viewModelScope.launch { viewSettingsRepo.updateFolderShowCount(show) }
    }

    fun updateFolderShowSize(show: Boolean) {
        viewModelScope.launch { viewSettingsRepo.updateFolderShowSize(show) }
    }

    fun updateFolderShowDate(show: Boolean) {
        viewModelScope.launch { viewSettingsRepo.updateFolderShowDate(show) }
    }

    fun updateFolderShowWatchBadge(show: Boolean) {
        viewModelScope.launch { viewSettingsRepo.updateFolderShowWatchBadge(show) }
    }

    fun updateShowSubtitle(show: Boolean) {
        viewModelScope.launch {
            viewSettingsRepo.updateShowSubtitle(show)
        }
    }
}
