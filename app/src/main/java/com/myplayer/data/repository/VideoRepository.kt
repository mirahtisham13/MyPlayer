...
import com.myplayer.data.model.FolderItem
import com.myplayer.data.model.VideoItem
...
class VideoRepository(
    ...
    val videoMetadataDao = com.myplayer.data.database.AppDatabase.getDatabase(context).videoMetadataDao()
        ...
        trashedItems.map { item ->
            ...
            if (item.size > 0 && item.duration > 0) {
                ...
                if (cached != null) {
                    ...
                    val extracted = com.myplayer.util.getVideoMetadata(context, item.uri)
            ...
            Video(
                ...
                subtitleExt = com.myplayer.util.SubtitleHelper.getSubtitleExtension(context, item.path)
            )
        }
    }
