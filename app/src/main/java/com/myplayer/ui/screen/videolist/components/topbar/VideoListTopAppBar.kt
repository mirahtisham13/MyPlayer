package com.myplayer.ui.screens.videolist.components.topbar
...
import com.myplayer.ui.common.popup.SearchSuggestionsPopup
                    ...
                    if (searchActive) {
                        ...
                        Box {
                            Row(
                                ...
                                Text(
                                    text = titleText ?: selectedStorage?.name ?: "MyPlayer",
                                    fontWeight = FontWeight.Bold,
                                    maxLines = 1,
