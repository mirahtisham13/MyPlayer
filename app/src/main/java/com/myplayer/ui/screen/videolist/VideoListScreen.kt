package com.myplayer.ui.screen.videolist
...
import com.myplayer.ui.components.CustomRenameDialog
import com.myplayer.ui.common.components.PreviewFloatingActionButton
import androidx.lifecycle.Lifecycle
import androidx.lifecycle.LifecycleEventObserver
import androidx.lifecycle.compose.LocalLifecycleOwner
import com.myplayer.ui.common.sheets.ViewSettingsBottomSheet
import com.myplayer.ui.screen.videolist.components.folder.FolderListContent
import com.myplayer.ui.common.sheets.InformationBottomSheet
import com.myplayer.ui.screen.StorageExplorerScreen

import com.myplayer.ui.screens.videolist.components.topbar.VideoListTopAppBar
import com.myplayer.ui.screen.videolist.components.video.VideoListContent
import com.myplayer.ui.screens.videolist.components.explorer.ExplorerListContent
import com.myplayer.ui.screens.videolist.components.explorer.ExplorerPathStrip
import com.myplayer.ui.screens.videolist.components.selection.VideoSelectionBottomBar
import com.myplayer.ui.screens.videolist.utils.applyFolderSort
import com.myplayer.ui.screens.videolist.utils.shareVideos
import com.myplayer.ui.common.components.SelectionBottomAppBar
...
fun VideoListScreen(
    ...
    LaunchedEffect(Unit) {
        fileOpsViewModel.pendingDeletionsFlow.collect { uris ->
            if (uris.isNotEmpty()) {
                fileOpsViewModel.deleteVideos(context, uris)
            }
        }
    }
    ...
    if (showInfoBottomSheet && isSelectionActive) {
        if (selectedFolders.isNotEmpty() && selectedVideos.isEmpty()) {
            com.myplayer.ui.screen.videolist.components.folder.FolderInfoDialog(
                selectedFolders = selectedFolders,
                videosByFolder = videosByFolder,
    ...
    if (showDeleteConfirmation) {
        ...
        AlertDialog(
            ...
            text = { Text("Are you sure you want to delete the selected video(s)?") },
            confirmButton = {
                TextButton(
                    onClick = {
