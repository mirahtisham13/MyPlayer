package com.myplayer.ui.screen.videolist.components.common
...
import com.myplayer.util.formatRelativeTime
import com.myplayer.util.formatResolutionCompact
...
fun VideoMetadataChips(
    ...
    val tokens = buildList {
        ...
        if (settings.showFileExtension) {
            val ext = video.title.substringAfterLast(".", "").uppercase()
            if (ext.isNotEmpty()) add(MetaToken(ext))
        }
